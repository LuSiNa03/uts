...
class ExperienceResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\TextInput::make('period')->placeholder('2022 – Present'),
            Forms\Components\TextInput::make('type')->placeholder('Freelance / Full-time'),
            Forms\Components\Textarea::make('description')->columnSpanFull(),
            Forms\Components\TagsInput::make('skills')->placeholder('Tambah skill, tekan Enter')->columnSpanFull(),
